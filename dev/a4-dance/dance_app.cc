...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
	...
	ballet_special3_.TrimFront(340);
	ballet_special3_.TrimBack(180);
	...
	ballet_special4_.TrimFront(340);
	ballet_special4_.TrimBack(160);
	...
	ballet_special5_.TrimFront(310);
	ballet_special5_.TrimBack(140);
