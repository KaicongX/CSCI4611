                                          ...
                                          const Matrix4 &view_matrix, const Matrix4 &proj_matrix)
{
    ...
    */
    ...
    if (bone_name == "lowerback") {
		quick_shapes_.DrawLineSegment(ctm, view_matrix, proj_matrix, Color(0, 0, 1), Point3(0, 0, 0), Point3(0, 0, 0) + skeleton_.BoneDirectionAndLength(bone_name), 0.01);
		quick_shapes_.DrawCone(ctm * Matrix4::Scale(Vector3(0.3, 0.1, 0.3))*Matrix4::Translation(Vector3(0,-0.1,0)), view_matrix, proj_matrix, Color(1, 0.5, 0.6));
    }
	if (bone_name == "upperback") {
		quick_shapes_.DrawLineSegment(ctm, view_matrix, proj_matrix, Color(0, 0, 1), Point3(0, 0, 0), Point3(0, 0, 0) + skeleton_.BoneDirectionAndLength(bone_name), 0.01);
		quick_shapes_.DrawCone(ctm * Matrix4::Scale(Vector3(0.1, 0.2, 0.1)) * Matrix4::Translation(Vector3(0,0.15, 0)) * Matrix4::RotationX(3.14159), view_matrix, proj_matrix, Color(1, 0.5, 0.6));
	}
    if (bone_name == "thorax") {
		quick_shapes_.DrawLineSegment(ctm, view_matrix, proj_matrix, Color(0, 0, 1), Point3(0, 0, 0), Point3(0, 0, 0) + skeleton_.BoneDirectionAndLength(bone_name), 0.01);
    }
    ...
    if (bone_name == "head") {
		quick_shapes_.DrawSphere(ctm*Matrix4::Scale(Vector3(0.1, 0.1, 0.1)), view_matrix, proj_matrix, Color(0, 0, 1));
		quick_shapes_.DrawSphere(ctm*Matrix4::Scale(Vector3(0.04, 0.04, 0.04))*Matrix4::Translation(Vector3(0,2,-1)), view_matrix, proj_matrix, Color(1, 0.5, 0.6));
		quick_shapes_.DrawCone(ctm*Matrix4::Scale(Vector3(0.05, 0.05, 0.05))*Matrix4::Translation(Vector3(0.5, 2, -1))*Matrix4::RotationZ(3.14159/2), view_matrix, proj_matrix, Color(1, 0.5, 0.6));
		quick_shapes_.DrawCone(ctm*Matrix4::Scale(Vector3(0.05, 0.05, 0.05))*Matrix4::Translation(Vector3(-0.5, 2, -1))*Matrix4::RotationZ(-3.14159 / 2), view_matrix, proj_matrix, Color(1, 0.5, 0.6));

	}
    if (bone_name == "lclavicle") {
		quick_shapes_.DrawSphere(ctm*Matrix4::Scale(Vector3(0.08, 0.08, 0.07))*Matrix4::Translation(skeleton_.BoneDirectionAndLength(bone_name) + Vector3(1.8, 0.3, 0)), view_matrix, proj_matrix, Color(1, 0.5, 0.6));
	}
	...
	if (bone_name == "lradius" || bone_name == "rradius") {
		quick_shapes_.DrawLineSegment(ctm, view_matrix, proj_matrix, Color(0, 0, 1), Point3(0, 0, 0), Point3(0, 0, 0) + skeleton_.BoneDirectionAndLength(bone_name), 0.01);
	}
